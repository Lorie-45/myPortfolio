...
const Hero = () => {
  ...
  useEffect(() => {
    // Add a small delay to ensure animation runs after component mounts
    ...
    <section id="home" className="min-h-screen flex items-center pt-20 bg-gradient-to-br from-blue-50 to-indigo-50">
      <div className="container mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className={`transition-all duration-1000 delay-100 ${isVisible ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>
          <h4 className="text-portfolio-primary font-medium text-lg md:text-xl mb-3">Welcome to my portfolio</h4>
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 text-portfolio-dark leading-tight">
            I'm a <span className="text-portfolio-primary">Full Stack</span> Web Developer
          </h1>
          <p className="text-portfolio-text text-lg mb-8 max-w-xl">
            I build beautiful, responsive and functional web applications using modern technologies.
        ...
        {/* Right Image */}
        <div className={`flex justify-center items-center transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100' : 'opacity-0 translate-x-10'}`}>
